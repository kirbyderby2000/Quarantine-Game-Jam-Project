...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private float pull_JumpSpeed;
        ...
        private void Update()
        {
            ...
            if (!m_Jump)
            {
                m_Jump = CrossPlatformInputManager.GetButtonDown("Jump") || pullJump;
            }
        ...
        private void FixedUpdate()
        {
            ...
            if (m_CharacterController.isGrounded || pullJump)
            {
        ...
        public void ChangeCursorLockState(bool state)
        {
            m_MouseLook.SetCursorLock(state);
            m_MouseLook.lockCursor = state;
            m_MouseLook.UpdateCursorLock();
